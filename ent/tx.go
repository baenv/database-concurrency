...
func (tx *Tx) init() {
	tx.CreateTicketLog = NewCreateTicketLogClient(tx.config)
	tx.ServiceProdiver = NewServiceProdiverClient(tx.config)
...
// applies a query, for example: CreateTicketLog.QueryXXX(), the query will be executed
