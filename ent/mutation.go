...
const (
	...
	// Node types.
	TypeCreateTicketLog = "CreateTicketLog"
...
// CreateTicketLogMutation represents an operation that mutates the CreateTicketLog nodes in the graph.
type CreateTicketLogMutation struct {
	config
	op            Op
	typ           string
	id            *uuid.UUID
	...
	oldValue      func(context.Context) (*CreateTicketLog, error)
	predicates    []predicate.CreateTicketLog
}

var _ ent.Mutation = (*CreateTicketLogMutation)(nil)

// createticketlogOption allows management of the mutation configuration using functional options.
type createticketlogOption func(*CreateTicketLogMutation)

// newCreateTicketLogMutation creates new mutation for the CreateTicketLog entity.
func newCreateTicketLogMutation(c config, op Op, opts ...createticketlogOption) *CreateTicketLogMutation {
	m := &CreateTicketLogMutation{
		config:        c,
		op:            op,
		typ:           TypeCreateTicketLog,
...
func withCreateTicketLogID(id uuid.UUID) createticketlogOption {
	return func(m *CreateTicketLogMutation) {
		var (
			err   error
			once  sync.Once
			value *CreateTicketLog
		)
		m.oldValue = func(ctx context.Context) (*CreateTicketLog, error) {
			once.Do(func() {
				if m.done {
					err = errors.New("querying old values post mutation is not allowed")
				} else {
					value, err = m.Client().CreateTicketLog.Get(ctx, id)
				}
			})
			return value, err
		}
...
// withCreateTicketLog sets the old CreateTicketLog of the mutation.
func withCreateTicketLog(node *CreateTicketLog) createticketlogOption {
	return func(m *CreateTicketLogMutation) {
		m.oldValue = func(context.Context) (*CreateTicketLog, error) {
			return node, nil
		}
		m.id = &node.ID
	}
...
func (m CreateTicketLogMutation) Client() *Client {
...
func (m CreateTicketLogMutation) Tx() (*Tx, error) {
...
func (m *CreateTicketLogMutation) IDs(ctx context.Context) ([]uuid.UUID, error) {
	...
	case m.op.Is(OpUpdate | OpDelete):
		return m.Client().CreateTicketLog.Query().Where(m.predicates...).IDs(ctx)
	default:
...
func (m *CreateTicketLogMutation) SetUniqueID(u uuid.UUID) {
	m.unique_id = &u
}

// UniqueID returns the value of the "unique_id" field in the mutation.
func (m *CreateTicketLogMutation) UniqueID() (r uuid.UUID, exists bool) {
	v := m.unique_id
	if v == nil {
		return
	}
...
// OldUniqueID returns the old "unique_id" field's value of the CreateTicketLog entity.
// If the CreateTicketLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CreateTicketLogMutation) OldUniqueID(ctx context.Context) (v uuid.UUID, err error) {
...
func (m *CreateTicketLogMutation) ResetUniqueID() {
	m.unique_id = nil
}

// SetCreatedAt sets the "created_at" field.
func (m *CreateTicketLogMutation) SetCreatedAt(t time.Time) {
	m.created_at = &t
}

// CreatedAt returns the value of the "created_at" field in the mutation.
func (m *CreateTicketLogMutation) CreatedAt() (r time.Time, exists bool) {
	v := m.created_at
	if v == nil {
		return
	}
...
// OldCreatedAt returns the old "created_at" field's value of the CreateTicketLog entity.
// If the CreateTicketLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CreateTicketLogMutation) OldCreatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CreateTicketLogMutation) ResetCreatedAt() {
	m.created_at = nil
}

// SetUpdatedAt sets the "updated_at" field.
func (m *CreateTicketLogMutation) SetUpdatedAt(t time.Time) {
	m.updated_at = &t
}

// UpdatedAt returns the value of the "updated_at" field in the mutation.
func (m *CreateTicketLogMutation) UpdatedAt() (r time.Time, exists bool) {
	v := m.updated_at
	if v == nil {
		return
	}
...
// OldUpdatedAt returns the old "updated_at" field's value of the CreateTicketLog entity.
// If the CreateTicketLog object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CreateTicketLogMutation) OldUpdatedAt(ctx context.Context) (v time.Time, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CreateTicketLogMutation) ResetUpdatedAt() {
	m.updated_at = nil
}

// Where appends a list predicates to the CreateTicketLogMutation builder.
func (m *CreateTicketLogMutation) Where(ps ...predicate.CreateTicketLog) {
	m.predicates = append(m.predicates, ps...)
}

// Op returns the operation name.
func (m *CreateTicketLogMutation) Op() Op {
	return m.op
}

// Type returns the node type of this mutation (CreateTicketLog).
func (m *CreateTicketLogMutation) Type() string {
	return m.typ
}
...
func (m *CreateTicketLogMutation) Fields() []string {
	...
	if m.created_at != nil {
		fields = append(fields, createticketlog.FieldCreatedAt)
	}
	if m.updated_at != nil {
		fields = append(fields, createticketlog.FieldUpdatedAt)
	}
	return fields
}
...
func (m *CreateTicketLogMutation) OldField(ctx context.Context, name string) (ent.Value, error) {
	...
	return nil, fmt.Errorf("unknown CreateTicketLog field %s", name)
}
...
func (m *CreateTicketLogMutation) SetField(name string, value ent.Value) error {
	...
	return fmt.Errorf("unknown CreateTicketLog field %s", name)
}

// AddedFields returns all numeric fields that were incremented/decremented during
// this mutation.
func (m *CreateTicketLogMutation) AddedFields() []string {
	return nil
}
...
func (m *CreateTicketLogMutation) AddedField(name string) (ent.Value, bool) {
	return nil, false
}
...
// the field is not defined in the schema, or if the type mismatched the field
// type.
func (m *CreateTicketLogMutation) AddField(name string, value ent.Value) error {
	switch name {
	}
	return fmt.Errorf("unknown CreateTicketLog numeric field %s", name)
}

// ClearedFields returns all nullable fields that were cleared during this
// mutation.
func (m *CreateTicketLogMutation) ClearedFields() []string {
	return nil
}

// FieldCleared returns a boolean indicating if a field with the given name was
// cleared in this mutation.
func (m *CreateTicketLogMutation) FieldCleared(name string) bool {
...
func (m *CreateTicketLogMutation) ClearField(name string) error {
	return fmt.Errorf("unknown CreateTicketLog nullable field %s", name)
}
...
func (m *CreateTicketLogMutation) AddedEdges() []string {
...
func (m *CreateTicketLogMutation) AddedIDs(name string) []ent.Value {
	return nil
}

// RemovedEdges returns all edge names that were removed in this mutation.
func (m *CreateTicketLogMutation) RemovedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *CreateTicketLogMutation) RemovedIDs(name string) []ent.Value {
	return nil
}

// ClearedEdges returns all edge names that were cleared in this mutation.
func (m *CreateTicketLogMutation) ClearedEdges() []string {
	edges := make([]string, 0, 0)
	return edges
}
...
func (m *CreateTicketLogMutation) EdgeCleared(name string) bool {
	return false
}

// ClearEdge clears the value of the edge with the given name. It returns an error
// if that edge is not defined in the schema.
func (m *CreateTicketLogMutation) ClearEdge(name string) error {
	return fmt.Errorf("unknown CreateTicketLog unique edge %s", name)
}

// ResetEdge resets all changes to the edge with the given name in this mutation.
// It returns an error if the edge is not defined in the schema.
func (m *CreateTicketLogMutation) ResetEdge(name string) error {
	return fmt.Errorf("unknown CreateTicketLog edge %s", name)
}
